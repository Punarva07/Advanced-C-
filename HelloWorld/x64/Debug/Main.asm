...
PUBLIC	??_C@_08KNLKNFCK@Hello?5OP@			; `string'
...
CONST	ENDS
;	COMDAT ??_C@_08KNLKNFCK@Hello?5OP@
CONST	SEGMENT
??_C@_08KNLKNFCK@Hello?5OP@ DB 'Hello OP', 00H		; `string'
CONST	ENDS
;	COMDAT xdata
xdata	SEGMENT
...
_TEXT	SEGMENT
main	PROC						; COMDAT
; File C:\Advance C++\TheCherno\Advanced-Cpp\HelloWorld\Main.cpp
; Line 6
$LN3:
	push	rbp
	push	rdi
	sub	rsp, 232				; 000000e8H
	lea	rbp, QWORD PTR [rsp+32]
	lea	rcx, OFFSET FLAT:__990DCB84_Main@cpp
	call	__CheckForDebuggerJustMyCode
; Line 7
	lea	rcx, OFFSET FLAT:??_C@_08KNLKNFCK@Hello?5OP@
	call	?Log@@YAXPEBD@Z				; Log
; Line 8
	lea	rdx, OFFSET FLAT:??_C@_0M@KPLPPDAC@Hello?5World@
